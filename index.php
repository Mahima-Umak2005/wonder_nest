...
<head>
    ...
    <title>WonderNest - Premium Hotel Booking</title>
...
<body>
    ...
    <section class="hero" id="home">
        <div class="hero-content">
            ...
            <button class="btn-book-now"><a href="login.php" style="text-decoration: none;">Book Now</a></button>
        </div>
    </section>
            ...
            <div class="hotels-grid">
                <div class="hotel-card">
                    ...
                    <div class="hotel-info">
                        ...
                        <button class="btn-view-hotel" ><a href="login.php" style="text-decoration: none;">View Details</a></button>
                    </div>
                </div>
                ...
                <div class="hotel-card">
                    <div class="hotel-image"><img src="images/Ramada Resort by Wyndham Kochi.jpg" alt=""></div>
                    <div class="hotel-info">
